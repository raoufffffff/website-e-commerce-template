...
const { email, facebook, instgarm, logo, main_color, phone, store_name, tiktok, id, TiktokPixel, facebookPixel, header, thanks, faqs, language } = data
...
export default { email, facebook, secondColor, instgarm, logo, main_color, phone, store_name, tiktok, id, textColor, TiktokPixel, facebookPixel, header, thanks, faqs, language } 